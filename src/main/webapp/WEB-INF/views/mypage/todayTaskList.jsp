          ...
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              ...
              <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                      ...
                      <li class="breadcrumb-item active">오늘까지 일감</li>
                  </ol>
              </div>
...
<div class="btn-group">
	...
	<form action ="/task/todayTaskList" method="get" id="frm">
	<input type="hidden" value="${memberVO.memNo}" name="memNo" />
    <select class="form-select btn-light btn-sm" name="projId" id="selectProj" required="">
				...
				<table class="table table-borderless table-nowrap" id="taskTable">
				    ...
				    <tbody>
				        ...
				        <tr id="tr${stat.index}" style="display:show;">
		            		...
		            		<td><a href="/task/taskDetail/${list.taskNo}/${list.pmemGrp}?newProjId=${lis.projId}">${list.taskTtl}</a></td>
				            <td >${list.projTtl}</td>
				            <c:choose>
