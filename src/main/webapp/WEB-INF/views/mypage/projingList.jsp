...
<script type="text/javascript">
 $(function(){
		$("#seach").on("click",function(){
			...
			location.href = "/project/projingList?cont="+cont+"&memNo=<%=memNo%>";
		});

		/* 전체보기 */
		$("#showAll").on("click",function(){
			location.href = "/project/projingList?cont=&memNo=<%=memNo%>";
		}); 
		
	 	//더 보기 클릭
		$("#moreList").on("click",function(){
			console.log("더보기 창");
			location.href = "/project/projingList?listcnt="+`${listcnt+1}`+"&memNo=<%=memNo%>";
		});
 });
</script>
          ...
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              ...
              <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                      ...
                      <li class="breadcrumb-item active">진행 프로젝트</li>
                  </ol>
              </div>
                          ...
                          <div class="card-body p-4" >
                              <div class="row align-items-center team-row" style="height:400px;">
                                  ...
                                  <div class="col-lg-2 col">
                                      <div class="text-end">
                                          <a href="/project/projMain/${projectList.projId}/${projectList.pmemGrp}" class="btn btn-light view-btn">프로젝트 홈으로</a>
                                      </div>
                                  </div>
                              </div>
                          </div>
                  ...
                  <!--end col-->
                  	<div class="row g-4 mb-2">
								<div class="col-12 text-center">
									<a class="btn btn-ghost-secondary waves-effect waves-light"
